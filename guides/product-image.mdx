...
Selektable.open('widget_abc123', {
  ...
  // The full gallery (including lifestyle shots) for the image selector
  productImages: [
...
- **`productImages`** — the full gallery shown in the widget's image selector. Customers can browse these and switch which image is used for generation.
